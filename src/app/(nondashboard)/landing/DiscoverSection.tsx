    ...
    <section>
      <motion.div
        ...
        <div className="px-6 sm:px-8 lg:px-12 xl:px-16 max-w-6xl xl:max-w-7xl mx-auto">
          <motion.div variants={itemVarients} className="my-12 text-center">
            ...
            {[
              {
                ...
                description:
                  "Browse through our extensive collection of rental listings in your desired location."
              },
              {
                imageSrc: "/landing-icon-calendar.png",
                title: "Book Your Rental",
                description:
                  "Find your ideal rental property and book it directly through our platform."
              },
              {
