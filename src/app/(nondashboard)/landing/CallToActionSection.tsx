    ...
    <section>
      <div className="relative py-24">
        <Image
          ...
          alt="Rentura Search Section Background"
          fill
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div>
              ...
              <div className="flex justify-center md:justify-start gap-4">
                <button
                  className="inline-block text-primary-700 bg-white rounded-lg px-6 py-3 
                    font-semibold hover:bg-primary-500 hover:text-primary-50"
                  onClick={() =>
