      ...
      <div className="flex justify-between items-center gap-4 p-2">
        ...
        <div className="flex items-center">
          ...
          <Button
            ...
            className={`rounded-r-xl rounded-l-none border-l-0 border-primary-400 shadow-none border hover:bg-primary-700 hover:text-primary-50`}
          >
        ...
        <div className="flex gap-1">
          ...
          >
            <SelectTrigger className="rounded-xl border-primary-400! focus-visible:ring-0">
              <SelectValue>
