    ...
    >
      <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
        ...
        <div className="flex items-center gap-5">
          {authUser ? (
            <>
              <div className="relative h-9 hidden md:flex items-center">
                <MessageCircle className="w-7 h-7 cursor-pointer text-primary-200 hover:text-primary-400" />
                <span className="absolute top-2 right-0 w-2 h-2 bg-secondary-700 rounded-full"></span>
              </div>
              <div className="relative h-9 hidden md:flex items-center">
                <Bell className="w-7 h-7 cursor-pointer text-primary-200 hover:text-primary-400" />
                <span className="absolute top-2 right-0 w-2 h-2 bg-secondary-700 rounded-full"></span>
              </div>
              <DropdownMenu>
